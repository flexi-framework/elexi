...
IF(NOT LIBS_BUILD_HDF5)
  ...
  IF(LIBS_USE_MPI)
    EXECUTE_PROCESS(COMMAND ldd ${HDF5_Fortran_LIBRARY_hdf5_fortran} COMMAND grep mpif08 OUTPUT_VARIABLE HDF5_USES_MPIF08 RESULT_VARIABLE GREP_RESULT OUTPUT_STRIP_TRAILING_WHITESPACE)
    IF(GREP_RESULT EQUAL 0)
      MESSAGE(STATUS "HDF5 Fortran library is linked against mpif08")
      SET(HDF5_HAS_MPIF08 TRUE)
    ELSE()
      MESSAGE(STATUS "HDF5 Fortran library is NOT linked against mpif08")
