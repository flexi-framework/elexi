...
USE MOD_FV_Vars          ,ONLY: FV_nExtendAlpha
...
DO i=1,FV_nExtendAlpha
  ...
  FV_alpha_current = 0.
  CALL FV_ComputeExtendedAlpha(FV_alpha_master,FV_alpha_slave,FV_alpha_current)
  DO iElem = 1,nElems
...
!==================================================================================================================================
SUBROUTINE FV_ProlongFValphaToFace(doMPISides)
! MODULES
...
DO SideID=firstSideID,lastSideID
  ...
  !master sides
  IF (ElemID   .GT. 0) FV_alpha_master(SideID) = FV_alpha(ElemID)
  !slave side (ElemID,locSide and flip =-1 if not existing)
  IF (nbElemID .GT. 0) FV_alpha_slave( SideID) = FV_alpha(nbElemID)
END DO
...
!==================================================================================================================================
SUBROUTINE FV_ComputeExtendedAlpha(FV_alpha_master,FV_alpha_slave,FV_alpha_current)
! MODULES
USE MOD_Globals
USE MOD_PreProc
