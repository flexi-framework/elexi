...
INTEGER                         :: nValues
TYPE(MPI_Request)               :: RecvRequestLeader(0:nSurfLeaders-1),SendRequestLeader(0:nSurfLeaders-1)
TYPE(MPI_Request)               :: RecvRequestShared(1:nComputeNodeProcessors-1),SendRequestShared!,ReduceRequestShared(6)
