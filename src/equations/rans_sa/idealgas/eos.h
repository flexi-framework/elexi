...
! Normal   U(1:6)  with conservative variables
! Extended U(1:13) with conservative and primitive variables

#define CONS  1:PP_nVar  /* conservative variables */
#define PRIM  1:PP_nVarPrim /* primitive variables */
...
#define EXT_MUSA    MUSA                       /* turbulent mu */
