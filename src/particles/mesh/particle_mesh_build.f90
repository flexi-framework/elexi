...
DO iVec = 1,GEO%nPeriodicVectors
  ...
  CALL MPI_ALLGATHER(sendbuf,1,MPI_DOUBLE_PRECISION,recvbuf(:),1,MPI_DOUBLE_PRECISION,MPI_COMM_FLEXI,iERROR)
  ...
  CALL MPI_BCAST(GEO%PeriodicVectors(:,iVec),3,MPI_DOUBLE_PRECISION,MINLOC(recvbuf(:),1)-1,MPI_COMM_FLEXI,iError)
END DO
#endif /*USE_MPI*/
...
USE MOD_MPI_Shared
! USE MOD_MPI_Shared_Vars          ,ONLY: nComputeNodeTotalElems
USE MOD_MPI_Shared_Vars          ,ONLY: nComputeNodeProcessors,nProcessors_Global,myComputeNodeRank
USE MOD_MPI_Shared_Vars          ,ONLY: MPI_COMM_SHARED,MPI_COMM_LEADERS_SHARED,displsElem,recvcountelem
#endif /*USE_MPI*/
#if USE_LOADBALANCE
