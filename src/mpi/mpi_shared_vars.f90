...
TYPE(MPI_Comm)                :: MPI_COMM_SHARED         =MPI_COMM_NULL !> Communicator on current compute-node
TYPE(MPI_Comm)                :: MPI_COMM_LEADERS_SHARED =MPI_COMM_NULL !> Communicator compute-node roots (my_rank_shared=0)
...
TYPE(MPI_Group)               :: MPI_GROUP_SHARED        =MPI_GROUP_NULL
TYPE(MPI_Group)               :: MPI_GROUP_LEADERS_SHARED=MPI_GROUP_NULL
