...
USE MOD_Particle_MPI_Shared_Vars,ONLY:ElemInfo_Shared,ElemSideNodeID_Shared,NodeCoords_Shared
#else
...
! TODO: Adjust this for new halo region
!! halo sides
...
! nothing more to do for procs without surfaces on them
